  ...
  default = {}
    ...
    map(
      object({
        ...
        default_message_ttl                      = (Optional) - Defaults to `null`. Mininum value of `PT5M` (5 minutes). The ISO 8601 timespan duration of the TTL of messages sent to this queue. This is the default value used when TTL is not set on message itself.
        ...
        auto_delete_on_idle                      = (Optional) - Defaults to `null`. Minimum of `PT5M` (5 minutes). The ISO 8601 timespan duration of the idle interval after which the Queue is automatically deleted.
